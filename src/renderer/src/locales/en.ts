...
export const en = {
  ...
  'detail.completedStatus': 'Completed',
  'detail.customType': 'Custom type',
  'detail.customTypePlaceholder': 'e.g. Prompt or Ops',
  'detail.applyCustom': 'Apply',
  ...
  'detail.githubIssueWarning': 'Use a valid HTTPS github.com Issue URL.',
  'detail.openGithubIssue': 'Open Issue',
  'detail.githubPullRequest': 'GitHub Pull Request',
  'detail.githubPullRequestPlaceholder': 'https://github.com/owner/repo/pull/456',
  'detail.githubPullRequestWarning': 'Use a valid HTTPS github.com Pull Request URL.',
  'detail.openGithubPullRequest': 'Open Pull Request',
